...
FocusScope {
    ...
    readonly property color cSurface: QsTheme.Theme.surface_container
    readonly property color cSurfaceContainer: QsTheme.Theme.surface_container_low
    readonly property color cSurfaceContainerHigh: QsTheme.Theme.surface_container_high
    readonly property color cPrimary: QsTheme.Theme.primary
    readonly property color cOnSurface: QsTheme.Theme.on_surface
    readonly property color cOnSurfaceVariant: QsTheme.Theme.on_surface_variant
    ...
    Item {
        ...
        onOpacityChanged: {
            if (opacity >= 1) passwordInput.forceActiveFocus()
        }
